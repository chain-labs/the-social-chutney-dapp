...
export const COLLECTION_NAME = "Rao Jodha: Founder of Jodhpur";

export const COLLECTION_DESCRIPTION = [
  "Rao Jodha, of the Rathore Clan. The founder of Jodhpur. Generated using AI.",
];
...
export const HERO_MEDIA =
  "https://ik.imagekit.io/xlvg9oc4k/jodhpur_treasure_hunt_1_tsc.png?updatedAt=1679716190869";
